 ...
 * r1:0 at reset (e.g. the QEMU virt machine's boot shim); h2 captures
 * those registers in its entry page.  Return the DTB physical address
 * if one was passed and looks valid, else 0.
 */
