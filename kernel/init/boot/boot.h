...
#define BOOT_TLB_SHIFT_4K (2 * SIZE_4K)
#define BOOT_TLB_SHIFT_1M (2 * SIZE_1M)
...
#define BOOT_TLB_OFFSET_BITS_4K (BOOT_TLB_ADDRBITS + BOOT_TLB_SHIFT_4K)
#define BOOT_TLB_OFFSET_BITS_1M (BOOT_TLB_ADDRBITS + BOOT_TLB_SHIFT_1M)
